...
export default function Cartbook() {
  ...
  return (
    <div>
      <button className=' fixed bottom-10 right-10 shadow-xl shadow-black rounded-full' onClick={() => setOpen(true)}> <img className='h-14 rounded-full hover:h-16 ease-in duration-300' src={image1} alt="" /> </button>
