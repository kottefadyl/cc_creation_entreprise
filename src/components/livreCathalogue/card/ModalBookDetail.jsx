        ...
        <Modal.Body>
          <div className='flex mx-auto '>
            ...
            <div className='text-neutral-600 w-full'>
              ...
              <div className='flex justify-between text-center items-center mx-20'>
                <button
                  onClick={()=>{handleSubmit();setShow(false)}}
                  type="submit"
                ...
                <button
                  type="submit"
                  className=" ml-4 mt-6 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-3 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  to rent out
                </button>
              </div>
